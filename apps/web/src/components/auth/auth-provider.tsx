...
type PluginAuthSlotProps = {
  className?: string
  socialLayout?: unknown
  socialPosition?: "top" | "bottom"
}

type PluginAuthButtonProps = {
  view: "signIn" | "signUp"
}
...
declare module "@better-auth-ui/core" {
  ...
  interface AuthPluginBase {
    authButtons?: ComponentType<PluginAuthButtonProps>[]
    captchaComponent?: ReactNode
    fallbackViews?: {
      auth?: Record<string, ComponentType<PluginAuthSlotProps>>
    }
    views?: {
      auth?: Record<string, ComponentType<PluginAuthSlotProps>>
    }
